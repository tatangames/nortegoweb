                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input style="color:#191818" autocomplete="off" type="text" id="nombre-nuevo" class="form-control" maxlength="100" />
                                    </div>

                                    <div class="form-group">
                                        <label>Teléfono</label>
                                        <input style="color:#191818"  autocomplete="off" type="text" id="telefono-nuevo" class="form-control" maxlength="20" />
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('/admin/agenda/tabla') }}";
    ...
    <script>
        ...
        function nuevoRegistro(){
            ...
            axios.post('/admin/agenda/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function solicitarBorrar(id){
            ...
            axios.post('/admin/agenda/borrar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
